...
/**
 * welp_all - Displays all possible builtin shellnas commands.
 */
void welp_all(void)
{
...
/**
 * welp_alias - Displays information on the shellnas builtin command 'alias'.
 */
void welp_alias(void)
{
...
/**
 * welp_cd - Displays information on the shellnas builtin command 'cd'.
 */
void welp_cd(void)
{
...
/**
 * welp_exit - Displays information on the shellnas builtin command 'exit'.
 */
void welp_exit(void)
{
...
/**
 * welp_help - Displays information on the shellnas builtin command 'help'.
 */
void welp_help(void)
{
	char *msg = "help: help\n\tSee all possible shellnas builtin commands.\n";
